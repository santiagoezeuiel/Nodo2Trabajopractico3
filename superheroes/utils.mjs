...
//Funcion para leer u ordenar los superheroes
...
export function leerSuperheroes(ruta){
    ...
    const superheroes = superheroesArray.map(
        hero => new Superheroe(hero.id, hero.nombreSuperheroe, hero.nombreReal, hero.nombreSociedad, hero.edad, hero.planetaOrigen, hero.debilidad,
...
//Nueva funcion para agregar superheróes
...
export function agregarSuperheroes(rutaOriginal, rutaNuevos) {
    ...
    //Convertir los nuevos Superheroes a instacias de Superheroes
    ...
    console.log('Lista de superheros actualizada con exito:');
}    